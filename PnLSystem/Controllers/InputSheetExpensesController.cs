    ...
    public class InputSheetExpensesController : ControllerBase
    {
        ...
        public async Task<ActionResult<BasePagingModel<IEnumerable<InputSheetExpense>>>> GetInputSheetExpenses([FromQuery] UserSearchModel searchModel, [FromQuery] PagingModel paging)
        {
            ...
            try
            {
                ...
                var list = await _context.InputSheetExpenses.Where(o => o.Name.ToString().Contains(searchModel.SearchTerm) || o.Description.ToString().Contains(searchModel.SearchTerm) || o.CreationDate.ToString().Contains(searchModel.SearchTerm) || o.Sheet.Store.Name.ToString().Contains(searchModel.SearchTerm) || o.Sheet.Brand.Name.ToString().Contains(searchModel.SearchTerm) || o.Stock.Name.ToString().Contains(searchModel.SearchTerm)).ToListAsync();
