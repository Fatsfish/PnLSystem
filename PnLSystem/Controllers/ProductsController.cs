    ...
    public class ProductsController : ControllerBase
    {
        ...
        public async Task<ActionResult<BasePagingModel<IEnumerable<Product>>>> GetProducts([FromQuery] UserSearchModel searchModel, [FromQuery] PagingModel paging)
        {
            ...
            try
            {
                ...
                var list = await _context.Products.Where(o => o.Name.ToString().Contains(searchModel.SearchTerm) || o.Description.ToString().Contains(searchModel.SearchTerm) || o.Category.Name.ToString().Contains(searchModel.SearchTerm) || o.IsDelete.ToString().Contains(searchModel.SearchTerm)).ToListAsync();
